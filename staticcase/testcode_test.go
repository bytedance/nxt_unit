...
// TODO: @guancheng.liu fix it
//func TestGenerateTestsV2(t *testing.T) {
//	gt, err := GenerateTests(path.Join(atgconstant.GOPATHSRC, atgconstant.ProjectPath, "/workflow/entities/testcase/variablecard/internal/input/input.go"), &Options{
//		TemplateDir: path.Join(atgconstant.GOPATHSRC, atgconstant.ProjectPath, "/workflow/entities/testcase/variablecard/internal/render/templates"),
//	})
//	if err != nil {
//		t.Fatal(err)
//	}
//	t.Log(string(gt[0].Output))
//}
